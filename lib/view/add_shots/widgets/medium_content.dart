...
class MediumContent extends StatefulWidget {
  @override
  _MediumContentState createState() => _MediumContentState();
}

class _MediumContentState extends State<MediumContent> {
  @override
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Padding(
        padding: EdgeInsets.symmetric(horizontal: _screenSize.width * (ResponsiveLayout.isLargeScreen(context) ? 0.1 : ResponsiveLayout.isMediumScreen(context) ? 0.05 : 0.01)),
        child: Column(
